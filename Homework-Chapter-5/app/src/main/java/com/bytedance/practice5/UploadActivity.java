...
//        RequestBody contentBody =RequestBody.create(MediaType.parse("text/plain"), content);
        ...
        newThreadToSubmit(call); //新开一个线程用来submit
    }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(UploadActivity.this,"上传失败QAQ"+e.toString(),Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (httpURLConnection.getResponseCode() == 200){
                        ...
                        throw new  IOException("上传失败惹QAQ");
                    }
                }catch (Exception e){
                    e.printStackTrace();
                    runOnUiThread(new Runnable() {
