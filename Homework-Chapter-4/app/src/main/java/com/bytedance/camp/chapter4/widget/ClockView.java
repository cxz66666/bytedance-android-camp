...
public class ClockView extends View {
    ...
    private static final float TEXT_LENGTH_RATIO=0.84f;//文字位置相对半径的比例
    ...
    private void drawTimeNeedles(Canvas canvas) {
         ...
         */
         double hourDegree = (hour-3)*30+minute*0.5+second*0.0083;
        ...
        double minuteDegree=(minute-15)*UNIT_DEGREE+second*0.1;
        ...
        double secondDegree=(second-15)*UNIT_DEGREE;
    ...
    private void drawTimeNumbers(Canvas canvas) {
        ...
        for(int i=0;i<12;i++){
            ...
            float posX = (float) (centerX + radius * TEXT_LENGTH_RATIO * Math.cos(Math.toRadians(degree)));
            float posY= (float)(centerY+radius*TEXT_LENGTH_RATIO* Math.sin(Math.toRadians(degree)));
            canvas.drawText(i+"",posX,posY,numberPaint);
        }
    }
